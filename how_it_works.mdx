...
An [existing agent](/api-reference/call/create) can be specified by its `id`, or you can create a [transient agent](/api-reference/call/create.transient) on the fly.
